...
window.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])(".glazing_block", ".glazing_content", ".glazing_slider");
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])(".decoration_link", ".decoraction_block", ".decoration_slider");
...
var modals = function modals() {
  ...
  bindModal('.popup_engineer_btn', '.popup_engineer', '.popup_close_engineer');
...
var tabs = function tabs(tabsSelector, tabsContentSelector, tabsParentSelector) {
  ...
  tabsParent.addEventListener('click', function (event) {
    var target = event.target;
    console.log(target.parentNode.classList.contains(tabsSelector.slice(1)));
...
var timer = function timer() {
  var endOfPromotion = new Date(2022, 5, 18);
  ...
  function setTimer() {
    var today = new Date();
    var timeToEnd = endOfPromotion.getTime() - today.getTime();
    ...
    if (timeToEnd < 0) {
      ...
      var toDays = Number.parseInt(timeToEnd / (1000 * 60 * 60 * 24));
      var toHours = Number.parseInt(timeToEnd / (1000 * 60 * 60) - 24);
      var toMinutes = Number.parseInt(timeToEnd / (1000 * 60) - (toDays * 24 * 60 + toHours * 60));
      var toSeconds = Number.parseInt(timeToEnd / 1000 - (toDays * 24 * 60 * 60 + toHours * 60 * 60 + toMinutes * 60));
      toDays < 10 ? days.textContent = "0".concat(toDays) : days.textContent = "".concat(toDays);
      toHours < 10 ? hours.textContent = "0".concat(toHours) : hours.textContent = "".concat(toHours);
      toMinutes < 10 ? minutes.textContent = "0".concat(toMinutes) : minutes.textContent = "".concat(toMinutes);
      toSeconds < 10 ? seconds.textContent = "0".concat(toSeconds) : seconds.textContent = "".concat(toSeconds);
    }
  }
