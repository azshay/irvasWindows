...
var modals = function modals() {
  ...
  bindModal(document.querySelector('.popup_engineer_btn'), document.querySelector('.popup_engineer'), document.querySelector('.popup_close_engineer'));
  document.querySelectorAll('.phone_link').forEach(function (item) {
